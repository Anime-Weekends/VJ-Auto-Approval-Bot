...
async def op(_, m :Message):
    try:
        ...
        await m.reply_text("**<blockquote>⚠️ Aᴄᴄᴇss ᴅᴇɴɪᴇᴅ ! ⚠️</blockquote>\n\n<blockquote expandable>Pʟᴇᴀsᴇ ᴊᴏɪɴ ᴍʏ ᴜᴘᴅᴀᴛᴇ ᴄʜᴀɴɴᴇʟ ᴛᴏ ᴜsᴇ ᴍᴇ.ɪғ ʏᴏᴜ ᴊᴏɪɴᴇᴅ ᴛʜᴇ ᴄʜᴀɴɴᴇʟ ᴛʜᴇɴ ᴄʟɪᴄᴋ ᴏɴ ʀᴇᴛʀʏ ʙᴜᴛᴛᴏɴ ᴛᴏ ᴄᴏɴғɪʀᴍ.</blockquote>**", reply_markup=key)
        return 
